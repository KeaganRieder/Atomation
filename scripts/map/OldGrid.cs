...
// 	/// </summary>
// 	public class OldGrid<GridObj> where GridObj : IThing
// 	{
...
// 		public OldGrid(int width, int height, float cellSize, Vector2 origin, Node2D chunk)
// 		{
// 			Width = width;
// 			Height = height;
// 			CellSize = cellSize;
...
// 		{
// 			int x = obj.Coordinate.GetXYPosition().X;
// 			int y = obj.Coordinate.GetXYPosition().X;

...
namespace Atomation.Map
{
	...
	public class ChunkHandler
	{
		...
		/// <summary>
		/// no chunk was/or has been cerated before at given cords so create 
		/// new one
		/// </summary>
		...
		// /// <summary>
		// /// check if given chunk has any generated neighbours, or if it can also be assigned
		// /// as one
		// /// </summary>
		// private void GetNeighbours(Chunk chunk){

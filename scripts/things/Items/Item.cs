...
//         Configure(ThingDatabase.Instance.GetItemDef(name), true);
//     }
...
//         graphic.Name = name + cords.ToString();
...
//         {
//             quantity = stackLimit;
//             GD.PrintErr($"Set Item {name} to be over stack limit");
//         }
//         if (quantity < 0)
//         {
//             quantity = 0;
//             GD.PrintErr($"Set Item {name} to be less then 0");
//         }
//     }

...
// 					CordConversion.SampleChunkPos(origin, x, y, out float sampleX, out float sampleY);
...
// 						terrain = new(new(x, y));
// 						CordConversion.SampleChunkPos(origin, x, y,  out float sampleChunkX, out float sampleChunkY);
// 					}

// 					GenerateLandscape(terrain);
...
// 		private void GenerateLandscape(Terrain terrain)
// 		{

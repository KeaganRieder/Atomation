...
namespace Atomation.Map
{
	...
	public class MapSettings
	{
		...
		public void FormatConfig(){
			FileManger.WriteJsonFile(FileManger.CONFIGS, "default_map_settings", this);
		}
	}
	...
	public class MapGenSettings
	{
		...
		public MapGenSettings(){
			moistureSettings = new NoiseMapSettings();
			temperatureSettings = new NoiseMapSettings();
			elevationSettings = new NoiseMapSettings();
		}
	}

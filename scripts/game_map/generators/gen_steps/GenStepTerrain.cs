...
public class GenStepLandScape : Generator<object>
{
    ...
    public void Generate(out Terrain[,] generatedTiles, Vector2 offset = default, Vector2I size = default)
    {
        if (!Validate())
        {
